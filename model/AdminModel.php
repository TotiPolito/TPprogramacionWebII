...
class AdminModel
{
    ...
    public function obtenerEstadisticasGenerales()
    {
        ...
        $stats["total_partidas"] = $db->query("SELECT COUNT(*) as total FROM partida")->fetch_assoc()["total"];
        $stats["promedio_puntaje"] = $db->query("SELECT AVG(puntaje) as promedio FROM usuarios")->fetch_assoc()["promedio"];
        $stats["mejor_jugador"] = $db->query("SELECT usuario, puntaje FROM usuarios ORDER BY puntaje DESC LIMIT 1")->fetch_assoc();
